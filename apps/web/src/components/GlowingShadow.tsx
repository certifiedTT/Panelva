    ...
    <>
      <style jsx>{`
        ...
        .glow-container {
          ...
          --card-radius: var(--glow-radius-val, 12px);
          --card-width: var(--glow-width, 35vw);
          --border-width: 3px;
          --bg-size: 1;
          --hue: 0;
          --hue-speed: 1;
          ...
          aspect-ratio: var(--glow-aspect, 1.5/1);
          color: white;
          margin: auto;
          display: flex;
          align-items: center;
      ...
      <div 
        ...
        style={{
          ...style,
          // @ts-ignore
          "--glow-aspect": aspectRatio,
          "--glow-width": width,
          "--glow-radius-val": radius
        }}
      >
