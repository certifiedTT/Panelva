...
interface StateIconProps {
  ...
  className?: string;
  duration?: number;
  activeState?: boolean; // Optional manual override state rather than auto-toggle
}
...
export function SuccessIcon({ size = 40, color = "currentColor", className, duration = 2200, activeState }: StateIconProps) {
  const autoDone = useAutoToggle(duration);
  const done = activeState !== undefined ? activeState : autoDone;
  return (
...
export function MenuCloseIcon({ size = 40, color = "currentColor", className, duration = 2000, activeState }: StateIconProps) {
  const autoOpen = useAutoToggle(duration);
  const open = activeState !== undefined ? activeState : autoOpen;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
/* ─── 3. PLAY → PAUSE ─── */
export function PlayPauseIcon({ size = 40, color = "currentColor", className, duration = 2400, activeState }: StateIconProps) {
  const autoPlaying = useAutoToggle(duration);
  const playing = activeState !== undefined ? activeState : autoPlaying;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function LockUnlockIcon({ size = 40, color = "currentColor", className, duration = 2600, activeState }: StateIconProps) {
  const autoUnlocked = useAutoToggle(duration);
  const unlocked = activeState !== undefined ? activeState : autoUnlocked;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function CopiedIcon({ size = 40, color = "currentColor", className, duration = 2200, activeState }: StateIconProps) {
  const autoCopied = useAutoToggle(duration);
  const copied = activeState !== undefined ? activeState : autoCopied;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function NotificationIcon({ size = 40, color = "currentColor", className, duration = 2800, activeState }: StateIconProps) {
  const autoNotif = useAutoToggle(duration);
  const notif = activeState !== undefined ? activeState : autoNotif;
  return (
...
export function HeartIcon({ size = 40, color = "currentColor", className, duration = 2000, activeState }: StateIconProps) {
  const autoFilled = useAutoToggle(duration);
  const filled = activeState !== undefined ? activeState : autoFilled;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <motion.path
...
export function DownloadDoneIcon({ size = 40, color = "currentColor", className, duration = 2400, activeState }: StateIconProps) {
  const autoDone = useAutoToggle(duration);
  const done = activeState !== undefined ? activeState : autoDone;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function SendIcon({ size = 40, color = "currentColor", className, duration = 2600, activeState }: StateIconProps) {
  const autoSent = useAutoToggle(duration);
  const sent = activeState !== undefined ? activeState : autoSent;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <motion.g
        animate={sent
...
export function ToggleIcon({ size = 40, color = "currentColor", className, duration = 1800, activeState }: StateIconProps) {
  const autoOn = useAutoToggle(duration);
  const on = activeState !== undefined ? activeState : autoOn;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function EyeToggleIcon({ size = 40, color = "currentColor", className, duration = 2200, activeState }: StateIconProps) {
  const autoHidden = useAutoToggle(duration);
  const hidden = activeState !== undefined ? activeState : autoHidden;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function VolumeIcon({ size = 40, color = "currentColor", className, duration = 2400, activeState }: StateIconProps) {
  const autoMuted = useAutoToggle(duration);
  const muted = activeState !== undefined ? activeState : autoMuted;
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
